...
@router.post("/admin/products/", response_model=CartOut, status_code=status.HTTP_201_CREATED)
...
@router.post("/cart/add/", response_model=Order, status_code=status.HTTP_201_CREATED)
